...
from zeus.conf.constant import QUERY_HOST_DETAIL, HostStatus
...
class TestGetHostInfo(BaseTestCase):
    def setUp(self) -> None:
    ...
    @mock.patch.object(HostProxy, 'update_host_status')
    ...
    def test_get_host_info_from_ceres_should_return_host_info_when_all_is_right(
        ...
        mock_verify_request,
        mock_connect,
        mock_host_basic_info,
        mock_create_thread,
        mock_get_result,
        mock_update_host_status,
        mock_close,
    ):
        ...
        mock_update_host_status.return_value = None
    ...
    def test_get_host_info_from_ceres_should_return_all_host_info_is_empty_when_input_host_id_is_not_in_database(
        self, mock_token, mock_connect, mock_host_basic_info, mock_update_host_status, mock_close
    ):
    ...
    def test_get_host_info_should_return_host_info_is_empty_when_connect_host_failed(self, mock_execute_command):
        ...
        self.assertEqual({"host_id": 1, "host_info": {}, "status": HostStatus.OFFLINE}, result)
