...
from zeus.conf.constant import AGENT_METRIC_SET
...
class TestSetAgentMetricStatus(BaseTestCase):
    ...
    def setUp(self) -> None:
        self.mock_args = {"host_id": 1, "plugins": {"plugin_1": {"metric_1": "on", "metric_2": "on", "metric_3": "on"}}}
        ...
        self.header_with_token = {"Content-Type": "application/json; charset=UTF-8", "access_token": "123456"}
    ...
    def test_set_agent_metrics_status_should_return_set_succeed_when_all_is_right(
        ...
        mock_execute_command.return_value = state.SUCCEED, json.dumps(
            {"resp": {"plugin_1": {"failure": [], "success": ["metric_1", "metric_3", "metric_2"]}}}
        )
